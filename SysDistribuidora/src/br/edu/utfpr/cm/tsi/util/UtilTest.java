...
public class UtilTest {
    ...
    public void testValidarID() {
        ...
        String id = "1";
        br.edu.utfpr.cm.pi.util.Util instance = new br.edu.utfpr.cm.pi.util.Util();
    ...
    public void testValidaCPF() {
        ...
        boolean expResult = true;
        boolean result = br.edu.utfpr.cm.pi.util.Util.validaCPF(cpf);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
    ...
    public void testValidarCNPJ() {
        ...
        boolean expResult = true;
        boolean result = br.edu.utfpr.cm.pi.util.Util.validarCNPJ(str_cnpj);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
