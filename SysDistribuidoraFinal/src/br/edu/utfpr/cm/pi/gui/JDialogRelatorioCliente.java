 ...
 * @author TAYLY
 */
public class JDialogRelatorioCliente extends javax.swing.JDialog {

    /**
     * Creates new form JDialogGerarRelatorioCliente
     */
    public JDialogRelatorioCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(436, 259));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogRelatorioCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogRelatorioCliente dialog = new JDialogRelatorioCliente(new javax.swing.JFrame(), true);
